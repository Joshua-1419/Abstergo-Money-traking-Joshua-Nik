...
<div class="row">
     <font color="Turquoise"><div class="col-sm-11"><h3>Transactions</h3></div>
    <div class="col-md-1">
...
<a href="<?php echo APP_URL;?>/transactions/add"><button type="entrar" class="btn btn-default" >Nueva Transactions</button></a>
